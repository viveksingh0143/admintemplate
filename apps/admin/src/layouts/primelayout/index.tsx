...
import { Bars3Icon, BellIcon, BuildingStorefrontIcon, CalendarIcon, ChartPieIcon, ChevronDownIcon, Cog6ToothIcon, DocumentDuplicateIcon, FolderIcon, HomeIcon, MagnifyingGlassIcon, Square3Stack3DIcon, XMarkIcon } from '@heroicons/react/24/outline';
...
const navigation = [
  ...
  { name: 'Products', href: '/secure/products', icon: FolderIcon, current: false },
  { name: 'Containers', href: '/secure/warehouse/containers', icon: DocumentDuplicateIcon, current: false },
  { name: 'Inventory', href: '/secure/warehouse/inventories', icon: Square3Stack3DIcon, current: false },
  { name: 'Stores', href: '/secure/stores', icon: BuildingStorefrontIcon, current: false },
  { name: 'Calendar', href: '#', icon: CalendarIcon, current: false },
  { name: 'Reports', href: '/secure/reports', icon: ChartPieIcon, current: false },
]
                ...
                <Menu.Button className="-m-1.5 flex items-center p-1.5">
                  ...
                  <span className="hidden lg:flex lg:items-center">
                    <span className="ml-4 text-sm font-semibold leading-6 text-gray-900" aria-hidden="true">
                      ...
                      <div className='text-xs font-normal'>({sessionUser?.staff_id})</div>
                    </span>
